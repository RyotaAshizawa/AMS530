...
#SBATCH --array=0-2
#SBATCH --output=./logs/Ring_1024_%a.out
#SBATCH --error=./logs/Ring_1024_%a.out
...
do
    echo "Loop:" $i
    mpirun -n ${ProcArray[$SLURM_ARRAY_TASK_ID]} ./Ring_method.o 1024 0
done
